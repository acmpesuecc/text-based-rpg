...
<<<<<<< HEAD
prem = False  # decreases opp_att by 40
ultra = False  # decreases opp_att by 45
=======
BunSamosa_Armour= False #decreases opp_att by 50
ACM_Armour= False #decreases opp_att by 60
>>>>>>> 26b7f131d938d912560d567c6efc2e666f25d63e
...
def shop_Potion():
    ...
    L_Shop_Potion_1 = Label(frame_shop_potion,
                            text=f"You currently have {potion} Small potions and {ultra_potion} Ultra potions with you.\n"
...
def shop_potion_yes():
    ...
    L_Shop_Potion_Yes = Label(frame_shop_potion_yes,
                              text="Small potion that costs 250 gold will increase your HP by 30\n"
                                   "And..\n"
...
def shop_potions_small():
    ...
    B_shop_potion_small_main = Button(frame_shop_potion_small, text="Back",
                                      command=lambda: shop_potions_small_to_main())
...
def shop_potions_ultra():
    ...
    B_shop_potion_ultra_main = Button(frame_shop_potion_ultra, text="Back",
                                      command=lambda: shop_potions_ultra_to_main())
...
def shop_potions_medium():
    ...
    B_shop_potion_medium_main = Button(frame_shop_potion_medium, text="Back",
                                       command=lambda: shop_potions_medium_to_main())
...
<<<<<<< HEAD
        ...
        L_Shop_armor_owned = Label(frame_shop_armor, text="Right now you have prem")
        L_Shop_armor_owned.pack()
    elif ultra:
        L_Shop_armor_owned = Label(frame_shop_armor, text="Right now you have ultra")
        L_Shop_armor_owned.pack()
    L_Shop_armor_intro = Label(frame_shop_armor, text="We have 5 types of armors..\n"
                                                      "Iron_Armour, Mythril_Armour,Orichalium_Armour,ultra,prem\n"
=======
    L_Shop_armor_intro = Label(frame_shop_armor, text="We have 5 types of armors..\n"
...
<<<<<<< HEAD
    L_Shop_armor_Y_info = Label(frame_shop_armor_yes,
                                text="Iron_Armour costs 100 gold and increases your attack by 20\n"
                                     "Mythril_Armour costs 200 gold and increases your attack by 30\n"
                                     "Orichalium_Armour costs 300 gold and increases your attack by 40\n"
                                     "prem costs 400 gold and increases attack by 40\n"
                                     "ultra costs 600 gold and increases attack by 45\n")
=======
...
<<<<<<< HEAD
    B_Shop_armors_armor4 = Button(frame_shop_armors_no, text="prem", command=lambda: shop_armor_armor4())
    B_Shop_armors_armor4.pack()
    B_Shop_armors_armor5 = Button(frame_shop_armors_no, text="ultra", command=lambda: shop_armor_armor5())
=======
...
<<<<<<< HEAD
    ...
    if ultra == False:
        if gold > 400:
            gold = gold - 400
            L_shop_armors_armor4 = Label(frame_shop_armors_no, text="You now have prem\n"
=======
    global BunSamosa_Armour
    global ACM_Armour
...
<<<<<<< HEAD
        L_shop_armors_armor4 = Label(frame_shop_armors_no, text="You already have prem")
        L_shop_armors_armor4.pack()
...
<<<<<<< HEAD
    ...
    if ultra == False:
        if gold > 600:
            gold = gold - 600
            L_shop_armors_armor5 = Label(frame_shop_armors_no, text="You now have ultra\n"
=======
    global BunSamosa_Armour
    global ACM_Armour
...
<<<<<<< HEAD
        L_shop_armors_armor5 = Label(frame_shop_armors_no, text="You already have ultra")
        L_shop_armors_armor5.pack()
...
def monster_potion_1():
    ...
    B_monster_potion_small = Button(frame_monster_potion_1, text="Small Potion",
                                    command=lambda: monster_potion_1_small())
    B_monster_potion_ultra = Button(frame_monster_potion_1, text="Ultra Potion",
                                    command=lambda: monster_potion_1_ultra())
    B_monster_potion_medium = Button(frame_monster_potion_1, text="Medium Potion",
                                     command=lambda: monster_potion_1_medium())
    B_monster_potion_medium.pack()
    B_monster_potion_small.pack()
    B_monster_potion_ultra.pack()
    B_monster_potion_back = Button(frame_monster_potion_1, text="back to battle",
                                   command=lambda: monster_potion_to_attack())
...
def monster_attack_1():
    ...
    if opp_hp <= 0:
        ...
        B__monster_attack_result_no = Button(frame_monster_attack_1, text="No",
                                             command=lambda: monster_rest_no_to_room())
...
def get_monster():
    ...
    L_monster_Wel.pack()
<<<<<<< HEAD
    monsters = ("Goblin", "Werewolf", "Basilisk", "Minotaur", "Griffin", "Dragon", "orc", "dark elf", "Mike", "Dave")
=======
