...
Mystic_Armour = False # decreases opp_att by 40
Wrath_Armour = False # decreases opp_att by 50
...
def shop_armor():
    ...
    if Iron_Armour:
        ...
        L_Shop_armor_owned = Label(frame_shop_armor, text="Right now you have Mystic_Armour")
        L_Shop_armor_owned.pack()
    elif Wrath_Armour:
         L_Shop_armor_owned = Label(frame_shop_armor, text="Right now you have Wrath_Armour")
         L_Shop_armor_owned.pack()

    
    L_Shop_armor_intro = Label(frame_shop_armor, text="We have 5 types of armors..\n"
                                                      "Iron_Armour, Mythril_Armour, Orichalium_Armour, Mystic_Armour and Wrath_Armour\n"
                                                      "Would you like to know more about them?\n")
...
def shop_armor_yes():
    ...
    L_Shop_armor_Y_info = Label(frame_shop_armor_yes, text="Iron_Armour costs 200 gold and increases your attack by 20\n"
                                                            ...
                                                            "Mystic_Armour costs 500 gold and increases your attack by 50\n"
                                                            "Wrath_Armour costs 600 gold and decreases your attack by 60\n")
...
def shop_armor_no():
    ...
    B_Shop_armors_armor3 = Button(frame_shop_armors_no, text="Mystic_Armour", command=lambda: shop_armor_armor4())
    B_Shop_armors_armor3.pack()
    B_Shop_armors_armor3 = Button(frame_shop_armors_no, text="Wrath_Armour", command=lambda: shop_armor_armor5())
    B_Shop_armors_armor3.pack()
...
def shop_armor_armor4():
    ...
    global Wrath_Armour
    global gold
    if Mystic_Armour == False:
        if gold > 200:
            gold = gold - 200
            L_shop_armors_armor1 = Label(frame_shop_armors_no, text="You now have Mystic Armour\n"
                                                                    f"You now have {gold} gold")
            L_shop_armors_armor1.pack()
            Iron_Armour = False
            Mythril_Armour = False
        ...
        L_shop_armors_armor1 = Label(frame_shop_armors_no, text="You already have Mystic_Armour")
        L_shop_armors_armor1.pack()
...
def shop_armor_armor5():
    ...
    global Wrath_Armour
    global gold
    if Wrath_Armour == False:
        if gold > 200:
            gold = gold - 200
            L_shop_armors_armor1 = Label(frame_shop_armors_no, text="You now have Wrath_Armour\n"
                                                                    f"You now have {gold} gold")
            L_shop_armors_armor1.pack()
            Iron_Armour = False
            Mythril_Armour = False
        ...
        L_shop_armors_armor1 = Label(frame_shop_armors_no, text="You already have Wrath_Armour")
        L_shop_armors_armor1.pack()
