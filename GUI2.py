...
Silver_Armour = False #decreases opp_att by 40
...
def shop_armor():
    ...
    L_Shop_armor_intro = Label(frame_shop_armor, text="We have 4 types of armors..\n"
                                                      "Iron_Armour, Mythril_Armour Orichalium_Armour and Silver_Armour\n"
                                                      "Would you like to know more about them?\n")
...
def shop_armor_yes():
    ...
    L_Shop_armor_Y_info = Label(frame_shop_armor_yes, text="Iron_Armour costs 200 gold and increases your attack by 20\n"
                                                            ...
                                                            "Orichalium_Armour costs 400 gold and increases your attack by 40\n"
                                                             "Silver_Armour costs 500 gold and increases your attack by 50\n")
...
def shop_armor_no():
    ...
    B_Shop_armors_armor4 = Button(frame_shop_armors_no, text="Silver_Armour", command=lambda: shop_armor_armor4())
