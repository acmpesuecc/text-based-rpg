...
diamond_armour = False  #decreases opp_att by 45
...
def shop_armor():
    ...
    if Iron_Armour:
        ...
        L_Shop_armor_owned.pack()
    elif platinum_armour:
        L_Shop_armor_owned = Label(frame_shop_armor, text="Right now you have Platinum_Armour")
        L_Shop_armor_owned.pack()
    elif diamond_armour:
    ...
    L_Shop_armor_intro = Label(frame_shop_armor, text="We have 5 types of armors..\n"
                                                      "Iron_Armour, Mythril_Armour,Orichalium_Armour,Diamond_Armour,Platinum_Armour\n"
                                                      "Would you like to know more about them?\n")
...
def shop_armor_yes():
    ...
    L_Shop_armor_Y_info = Label(frame_shop_armor_yes, text="Iron_Armour costs 100 gold and increases your attack by 20\n"
                                                            ...
                                                            "Platinum_Armour costs 400 gold and increases attack by 40\n"
                                                            "Diamond_Armour costs 600 gold and increases attack by 45\n")
...
def shop_armor_no():
    ...
    B_Shop_armors_armor4 = Button(frame_shop_armors_no, text="Platinum_Armour", command=lambda: shop_armor_armor4())
...
def shop_armor_armor4():
    ...
    if diamond_armour == False:
        if gold > 400:
            gold = gold - 400
            L_shop_armors_armor4 = Label(frame_shop_armors_no, text="You now have Platinum_Armour\n"
                                                                    f"You now have {gold} gold")
            L_shop_armors_armor4.pack()
            Iron_Armour = False
            Mythril_Armour = False
            Orichalium_Armour = False
            platinum_armour = True
            diamond_armour = False
        ...
        L_shop_armors_armor4 = Label(frame_shop_armors_no, text="You already have Platinum_Armour")
        L_shop_armors_armor4.pack()
...
def get_monster():
    ...
    L_monster_Wel.pack()
    monsters = ("Goblin", "Werewolf", "Basilisk", "Minotaur", "Griffin", "Dragon","orc","dark elf")
    ...
    if monster == "orc":
        ...
        # monster 7
        # Attack in range of 30-40
        L_m7_intro = Label(frame_monster_1, text="You have to face orc\n"
                                                 "The match starts. You get the first chance\n")
        L_m7_intro.pack()
        fight_monster()
        # opp_att = random.randint(30, 40)
    ...
    if monster == "darkelf":
        ...
        L_m8_intro = Label(frame_monster_1, text="You have to face Dark Elf\n"
                                                 "The match starts. You get the first chance\n")
        L_m8_intro.pack()
        fight_monster()
